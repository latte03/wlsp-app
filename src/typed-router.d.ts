...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'MassPage': RouteRecordInfo<'MassPage', '/mass', Record<never, never>, Record<never, never>>,
    'MassOpen': RouteRecordInfo<'MassOpen', '/mass/mass-open', Record<never, never>, Record<never, never>>,
    'MassPost': RouteRecordInfo<'MassPost', '/mass/mass-post', Record<never, never>, Record<never, never>>,
    'MyMass': RouteRecordInfo<'MyMass', '/mass/my-mass', Record<never, never>, Record<never, never>>,
