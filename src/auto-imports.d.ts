...
declare global {
  ...
  const useAssetsImageURL: typeof import('./composables/url-composable')['useAssetsImageURL']
  ...
  const useStationData: typeof import('./composables/station-data')['useStationData']
